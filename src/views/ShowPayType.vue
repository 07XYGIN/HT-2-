<template>
  <div><el-card class="box-card">
      ...
      <el-form>
        <el-form-item label="项目计费名称" label-width="150px">
          <p>{{ untlmsg.payname }}</p>
        </el-form-item>

        <el-form-item label="项目优先级" label-width="150px">
          <p>{{ untlmsg.paylevel }}</p>
        </el-form-item>

        <el-form-item label="项目用量/时长" label-width="150px">
          <p>{{ untlmsg.paytime }}</p>
        </el-form-item>
        <el-form-item label="项目价格" label-width="150px">
          <p>{{ untlmsg.paymoney }}</p>
        </el-form-item>

        <el-form-item label="通知状态" label-width="150px">
          <p>{{ untlmsg.paystatus == 1 ? '已缴费' : '未缴费' }}</p>
        </el-form-item>

        <el-form-item label="通知人" label-width="150px">
          <p>{{ untlmsg.username }}</p>
        </el-form-item>
        <el-form-item label="通知内容" label-width="150px">
          <p v-html="untlmsg.paycontent"></p>
        </el-form-item>
      </el-form>
    </el-card>
    <div>
      <el-button type="primary" @click="edithouse">编辑</el-button>
