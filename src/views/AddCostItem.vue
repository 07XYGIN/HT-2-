  ...
  <div class="main">
    <div>
      <el-form :inline="true" :model="selectform" class="demo-form-inline">
        <div class="inputs">
          <el-form-item label="计费项目名称" label-width="140px">
            <el-input v-model="selectform.payname" minlength="500px"></el-input>
          </el-form-item>
          <el-form-item label="项目优先级" label-width="140px">
            <el-input v-model="selectform.paylevel" minlength="500px"></el-input>
          </el-form-item>
          <el-form-item label="项目用量/时长" label-width="140px">
            <el-input v-model="selectform.paynum" minlength="500px"></el-input>
          </el-form-item>
          <el-form-item label="项目价格" label-width="140px">
            <el-input v-model="selectform.paymoney" minlength="500px"></el-input>
          </el-form-item>

          <el-form-item label="通知状态" label-width="140px">
            <el-select v-model="selectform.paystatus" placeholder="通知状态" minlength="500px">
              <el-option label="已通知" value="1"></el-option>
              <el-option label="未通知" value="2"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="计费目录" label-width="100px">
            <el-select v-model="selectform.c_id" placeholder="请选择计费项目" minlength="500px">
      ...
      <div class="rightsitck">
        <el-button type="success" @click="Submit"><i class="el-icon-plus"></i>录入</el-button>
        <el-button type="primary" @click="back">返回</el-button>
      </div>
    </div>
    <div>
      <Editor id="tinymce" v-model="selectform.paycontent" :init="init"></Editor>
    </div>
  </div>
</template>
