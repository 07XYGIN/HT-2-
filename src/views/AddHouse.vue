  ...
  <div class="main">
    <div>
      <el-form :inline="true" :model="selectform" class="demo-form-inline">
        <div class="inputs"><el-form-item label="小区名称" label-width="100px">
            <el-input v-model="selectform.communityname" placeholder="小区名称" minlength="500px"></el-input>
          </el-form-item>
          <el-form-item label="单元名称" label-width="100px">
            <el-input v-model="selectform.unitname" placeholder="单元名称" minlength="500px"></el-input>
          </el-form-item>
          <el-form-item label="  栋数 " label-width="100px">
            <el-input v-model="selectform.unitnum" placeholder="栋数" minlength="500px"></el-input>
          </el-form-item>

          <el-form-item label="建成状态" label-width="100px">
            <el-select v-model="selectform.unitstatus" placeholder="建成状态" minlength="500px">
    ...
    <div>
      <Editor id="tinymce" v-model="selectform.unitcontext" :init="init"></Editor>
    </div>
  </div>
</template>
