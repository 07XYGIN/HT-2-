    ...
    <el-form :model="Editform" status-icon ref="ruleForm" label-width="100px" class="demo-ruleForm">
      ...
      <div class="topsix">
        ...
        <el-form-item label="幢号" prop="buildnum">
          <el-input v-model="Editform.buildnum" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="楼层号" prop="storeynum">
          <el-input v-model="Editform.storeynum" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="房号" prop="homenum">
          <el-input v-model="Editform.homenum" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="住客姓名" prop="homename">
          <el-input v-model="Editform.homename" autocomplete="off" @focus="dialogVisible = true"></el-input>
        </el-form-item>
        <el-form-item label="入住状态">
          <el-select @change="ch3" :value="Editform.homestatus == null ? '' : (Editform.homestatus == 1 ? '完好' : '待维修')">
      ...
      <div class="twoarea">
        ...
        <div style="display: flex; justify-content: center;">
          <el-popover placement="top" width="100" trigger="hover" popper-class="mypopover">
            <p style="font-size: 11px; font-weight: 700;">可填写房屋的详细信息介绍：<br>
              1.房屋的基本信息 <br>
              2.房屋的成员信息 <br>
              3.房屋的设备信息 <br>
              4.房屋未来的规划填报</p>
            <i slot="reference" class="el-icon-question" style="line-height: 40px; color: rgb(32, 160, 255);"></i>
          </el-popover>
          <el-form-item label="房屋信息" label-width="80px">

            <el-input type="textarea" placeholder="请输入内容" v-model="Editform.homemessage" style="width: 90vw;">
            </el-input>
          </el-form-item>
        </div>
        <div style="display: flex; justify-content: center;">
          ...
          <el-form-item label="家庭成员" label-width="80px">
            ...
            <el-input type="textarea" placeholder="请输入内容" v-model="Editform.homesuggestion" style="width: 90vw;">
            </el-input>
          </el-form-item>
        </div>
      </div>
      ...
      <div class="topsix">
        <el-form-item label="洗衣机数量" prop="washnum">
          <el-input v-model="Editform.washnum" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="WI-FI名称" prop="wifiname">
          <el-input v-model="Editform.wifiname" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="空调数量" prop="airnum">
          <el-input v-model="Editform.airnum" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="智能设备状态">
          <el-select @change="ch2" :value="Editform.smartstatus == null ? '' : (Editform.smartstatus == 1 ? '完好' : '待维修')">
      ...
      <div class="topsix">
        <el-form-item label="书桌数量" prop="homedesk">
          <el-input v-model="Editform.homedesk" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="椅子数量" prop="homechair">
          <el-input v-model="Editform.homechair" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="衣橱数量" prop="homeclothes">
          <el-input v-model="Editform.homeclothes" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="家居设备状态">
          <el-select @change="ch1" :value="Editform.familystatus == null ? '' : (Editform.familystatus == 1 ? '完好' : '待维修')">
            <el-option label="完好" value="1"></el-option>
            <el-option label="待维修" value="2"></el-option>
          </el-select>
        </el-form-item>
      ...
      <el-dialog :visible.sync="dialogVisible" width="95%" :before-close="handleClose">
        <div>
          ...
          <div v-if="selectedOption === 'option1'">
            <el-form>
              <el-form-item>
                <el-input v-model="Editform.homename" autocomplete="off"></el-input>
              </el-form-item>
            </el-form>
          </div>
          ...
          <div v-if="selectedOption === 'option2'">
            ...
            <el-table :data="UsersData" stripe style="width: 100%">
              ...
              <el-table-column prop="homeaddress" label="家庭住址" width="300px">
              ...
              <el-table-column label="操作">
                <template slot-scope="scope">
                  ...
                  <i class="el-icon-circle-plus" @click="Add(scope.row)">添加</i>
                </template>
              </el-table-column>
            </el-table>
            <div class="block">
              ...
              <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
                :page-sizes="[7, 10, 20, 30]" :page-size="this.Userlist.pageNum" layout="total, sizes, prev, pager, next"
        ...
        <div>
          <el-table :data="selectedData" stripe border style="width: 100%">
            <el-table-column prop="id" label="ID">
            ...
            <el-table-column label="操作">
              <template slot-scope="scope">
                ...
                <i class="el-icon-circle-plus" @click="Remove(scope.row)">删除</i>
              </template>
            </el-table-column>
          </el-table>
        </div>
