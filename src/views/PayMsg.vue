<template>
  <div>
    ...
    <div class="main">
      <div class="leftview">
        <el-form ref="form" :model="paymsgsearch" label-position="top" label-width="120px">
          <el-form-item label="用户名" prop="username">
            <el-input v-model="paymsgsearch.username"></el-input>
          </el-form-item>
          <el-form-item label="支付名称">
            <el-select v-model="paymsgsearch.payname" placeholder="请选择支付名称">
          ...
          <el-form-item label="费用状态">
            <el-select v-model="paymsgsearch.coststatus" placeholder="请选择费用状态">
              <el-option label="已支付" value="已支付"></el-option>
              <el-option label="未支付" value="未支付"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="开始日期" prop="startDate">
            <el-date-picker v-model="startenddata" type="daterange" range-separator="至" start-placeholder="开始日期"
      ...
      <div class="rightview">
        ...
        <div> <el-table :id="'mytable'" :data="tableData" stripe style="width: 100%" @selection-change="select">
            <el-table-column prop="payname" label="缴费产品" width="180">
            ...
            <el-table-column label="操作" width="300">
              <template slot-scope="scope">
                ...
                <el-button size="mini" @click="down(scope.row)">导出</el-button>
        ...
        <div class="page"><el-pagination @size-change="changesize" @current-change="changepage"
            :page-sizes="[10, 20, 30, 40]" :page-size="this.paymsgsearch.pageNum" layout="total, sizes, prev, pager, next"
            :total="pagetotal">
          </el-pagination></div>
      </div>
    </div>
