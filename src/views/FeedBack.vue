  ...
  <div class="doc">
    <div>
      <el-form :inline="true" :model="selectform" class="demo-form-inline">
        <el-form-item>
          <el-select v-model="selectform.homestatus" placeholder="入住状态">
            <el-option label="入住" value="1"></el-option>
            <el-option label="未入住" value="2"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item>
          <el-input v-model="selectform.unitname" placeholder="单元名称"></el-input>
        </el-form-item>
        <el-form-item>
          <el-input v-model="selectform.buildnum" placeholder="幢号"></el-input>
        </el-form-item>
        ...
        <el-form-item>
          <el-input v-model="selectform.homename" placeholder="住客姓名"></el-input>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" @click="submit"><i class="el-icon-search"></i>查找</el-button>
        </el-form-item>
        ...
        <el-button type="danger" @click="delall"><i class="el-icon-delete-solid"></i>批量删除</el-button>
    ...
    <div> <el-table :id="'mytable'" :data="tableData" stripe style="width: 100%" @selection-change="select">
        ...
        <el-table-column prop="buildnum" label="幢号" width="180">
          <template scope="scope">
        ...
        <el-table-column prop="homestatus" label="状态">
          <template scope="scope">
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            <el-button size="mini" @click="editnum(scope.row)">编辑</el-button>
