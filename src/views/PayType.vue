<template>
  <div>
    <div class="main">
      <div class="leftview">
        <el-form :model="paydatasearch" status-icon>
          <div style="display: flex;     justify-content: space-around;">
            <el-form-item prop="pass">
              <el-input v-model="paydatasearch.parkname" autocomplete="off" class="wid" placeholder="项目价格"></el-input>
            </el-form-item>
            <el-form-item prop="checkPass">
              <el-select v-model="paydatasearch.paystatus" placeholder="通知状态" class="wid">
        ...
        <div>
          <el-tree :data="treeData" default-expand-all @node-click="treeclick"></el-tree>
        </div>
      </div>
      <div class="rightview">
        <div id="box">
          <el-button type="primary" @click="submit"><i class="el-icon-search"></i>搜索</el-button>

          <el-button type="success" @click="disposetable"><i class="el-icon-plus"></i>导出</el-button>

          <el-button type="success" @click="jptadd"><i class="el-icon-plus"></i>新增</el-button>
          <el-button type="primary" @click="reset"><i class="el-icon-refresh-right"></i>重置</el-button>

        </div>

        <div> <el-table :id="'mytable'" :data="tableData" stripe style="width: 100%" @selection-change="select">

            <el-table-column prop="payname" label="缴费项目名称" width="180">
              <template scope="scope">
                {{ scope.row.payname || '暂无' }}
              </template>
            </el-table-column>
            <el-table-column prop="paylevel" label="缴费项目优先级" width="180">
              <template scope="scope">
            ...
            <el-table-column prop="paymoney" label="项目价格">
              <template scope="scope">
            ...
            <el-table-column label="操作" width="300">
              <template slot-scope="scope">
                <el-button size="mini" @click="editnum(scope.row)">通知</el-button>
                <el-button size="mini" @click="showcost(scope.row)">查看</el-button>
                <el-button size="mini" type="danger" @click="Delete(scope.row)">删除</el-button>
              </template>
            </el-table-column>
          </el-table></div>
        <div class="page"><el-pagination @size-change="changesize" @current-change="changepage"
            :page-sizes="[10, 20, 30, 40]" :page-size="this.paydatasearch.pageNum"
            layout="total, sizes, prev, pager, next" :total="pagetotal">
          </el-pagination></div>
      </div>
    </div>
    <el-dialog title="提示" :visible.sync="editVisible" width="60%">

      <div>
        <el-table ref="singleTable" :data="userdata" highlight-current-row @current-change="userdatachange"
          style="width: 100%">
          <el-table-column type="index" label="序号" width="50">
          </el-table-column>
          <el-table-column property="username" label="用户账号" width="120">
          </el-table-column>
          <el-table-column property="address" label="家庭住址" width="120">
          </el-table-column>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="submituserdatachange">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
