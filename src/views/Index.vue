<template>
  <div>
    <div class="topmsg">
      <span>最新公告</span>
      <div class="scloop"> <el-carousel height="60px" direction="vertical" :autoplay="true">
          <el-carousel-item v-for="item in posterdata" :key="item.p_id">
    ...
    <div class="cardlist">
      <div class="cardlist1">
        <el-card class="box-card">
          <div class="card1content">
            <i class="el-icon-user" style="color: #389af9;"></i>
            <div>
              <p>
                {{ usernum }}
              </p>
        ...
        <el-card class="box-card">
          <div class="card1content">
            <i class="el-icon-s-order" style="color: #aee86a;"></i>
            <div>
              <p>
                {{ paynum }}
              </p>
        ...
        <el-card class="box-card">
          <div class="card1content">
            <i class="el-icon-truck" style="color: #f2b90e;"></i>
            <div>
              <p>
                {{ parks }}
              </p>
        ...
        <el-card class="box-card">
          <div class="card1content">
            <i class="el-icon-edit" style="color: #b28b7c;"></i>
            <div>
              <p>
                {{ feedback }}
              </p>
      ...
      <div class="cardlist2">
        <el-card class="box-card">
          <div class="pic1" ref="pic1"></div>
        </el-card>
        <el-card class="box-card">
          <div class="pic2" ref="pic2"></div>
        </el-card>
        <el-card class="box-card">
          <div class="pic3" ref="pic3"></div>
        </el-card>
      </div>
      <div class="cardlist3">
        <el-card class="box-card">
          <div class="pic4" ref="pic4"></div>
        </el-card>
        <el-card class="box-card">
          <div class="repairtext">
            <el-table ref="filterTable" :data="tableData" style="width: 100% font-size=14px " class="repairtext"
              :cell-style="{ padding: '0' }" :row-style="{ height: '45px' }">
              <el-table-column prop="repaircontent" label="维修内容" class="repairtext" show-overflow-tooltip>
              </el-table-column>
              <el-table-column prop="createtime" label="保修时间" class="repairtext" show-overflow-tooltip>
                <template slot-scope="scope">
                  {{ dayjs(scope.row.createtime) }}
                </template>
              </el-table-column>
              <el-table-column prop="resultstatus" label="状态" class="repairtext" show-overflow-tooltip>
                <template slot-scope="scope">
                  <el-tag :type="scope.row.resultstatus == '1' ? 'success' : 'warning'" disable-transitions>{{
                    tabletype[scope.row.resultstatus] }}</el-tag>
                </template>
              </el-table-column>
            </el-table>
            <div class="pagination-container">
              <el-pagination small layout="prev, pager, next" @current-change="changepaper"
                :page-size="tableparams.pageNum" :total="tabletotal">
              </el-pagination>
            </div>
          </div>
        </el-card>
